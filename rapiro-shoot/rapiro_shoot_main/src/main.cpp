...
#define MAXMN 9     // Max Number of Motions
...
int   readOneDigit();
int   readThreeDigit(int);
void  printThreeDigit(int);
void  nextFrame();
void  nextPose();
int   getPose();
...
{
  // 5 Hold a gun
  { 60, 90, 80, 90, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,255, 10},
  { 60, 90, 80, 90, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 90, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 90, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 90, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 90, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
...
{
  // 7 Point a gun to the right
  { 60, 90, 80, 80, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,255, 10},
  { 60, 90, 80, 80, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 80, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 80, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 80, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 80, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
...
{
  // 8 Point a gun to the left
  { 60, 90, 80, 100, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,255, 10},
  { 60, 90, 80, 100, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 100, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 100, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 100, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
  { 60, 90, 80, 100, 70, 180, 90, 90, 100, 90, 80, 90,  0,  0,  0,  0},
...
void setup()  {
  ...
  // 通電時にサーボモータが初期位置に戻ろうとして破壊されるのを防ぐためにシフト演算がされている
  for( i = 0; i < MAXSN; i++) {
...
void loop()  {
  ...
  if(endTime > millis()) {
    ...
    for( i = 0; i < MAXSN; i++) {
      ...
      servo[i].write((nowAngle[i] >> SHIFT) + trim[i]);                     //サーボ制御部
    }
    for( i = 0; i < 3; i++) {
